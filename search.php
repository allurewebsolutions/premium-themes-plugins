		...
		<div id="progression-studios-page-title-container">
			<div class="width-container-pro">
				<h1 class="page-title"><?php
					...
					printf( esc_html__( 'Search for: %s', 'the-food-truck-progression' ), '<span>' . get_search_query() . '</span>' );
					?></h1>
				<?php if ( !have_posts() ) : ?><h4 class="progression-sub-title"><?php esc_html_e( 'No Results Found', 'the-food-truck-progression' ); ?></h4><?php endif; ?>
