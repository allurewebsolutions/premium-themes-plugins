...
?>
	class="
		...
		<?php echo esc_attr( get_theme_mod( 'progression_studios_logo_position', 'progression-studios-logo-position-center') ); ?> 
...
?>
	...
	<?php if (get_theme_mod( 'progression_studios_header_sticky', 'none-sticky-pro' ) == 'sticky-pro' && get_theme_mod( 'progression_studios_logo_position', 'progression-studios-logo-position-center' ) == 'progression-studios-logo-position-center' ) : ?><div id="progression-sticky-header"><?php endif; ?>
	...
	<div class="optional-centered-area-on-mobile">
		...
		<div class="mobile-menu-icon-pro noselect"><i class="fa fa-bars"></i><?php if (get_theme_mod( 'progression_studios_mobile_menu_text') == 'on' ) : ?><span class="progression-mobile-menu-text"><?php echo esc_html__( 'Menu', 'the-food-truck-progression' )?></span><?php endif; ?></div>
	...
	<?php if (get_theme_mod( 'progression_studios_header_sticky', 'none-sticky-pro' ) == 'sticky-pro' && get_theme_mod( 'progression_studios_logo_position', 'progression-studios-logo-position-center' ) == 'progression-studios-logo-position-center' ) : ?></div><?php endif; ?>
...
function progression_studios_show_pagination_links_pro()
{
    ...
    echo paginate_links( array(
            ...
            'total'     => $page_tot,
            'prev_next' => true,
				'prev_text'    => '<span>' . esc_html__('&lsaquo; Previous', 'the-food-truck-progression') . '</span>',
				'next_text'    => '<span>' . esc_html__('Next &rsaquo;', 'the-food-truck-progression'). '</span>',
            'end_size'  => 1,
            'mid_size'  => 2,
            'type'      => 'list'
        )
...
function progression_studios_infinite_content_nav_pro( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<div id="infinite-nav-pro-default" class="infinite-nav-pro">
			<div class="nav-previous"><?php next_posts_link( wp_kses( __('Load More <span><i class="fa fa-arrow-circle-down"></i></span>', 'the-food-truck-progression' ) , TRUE) ); ?></div>
		</div>
	<?php endif;
}
endif;
