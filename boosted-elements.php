...
function boosted_elements_progression_plugin_enqueuing() {
	...
	wp_register_script( 'boosted_elements_progression_animated_js',  plugins_url( '/assets/js/animated-typing.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_countdown_js',  plugins_url( '/assets/js/countdown.min.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_popup_js',  plugins_url( '/assets/js/jquery.popupoverlay.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_scrollnav_js',  plugins_url( '/assets/js/scrollnav.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_masonry_js',  plugins_url( '/assets/js/masonry.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_prettyphoto_js',  plugins_url( '/assets/js/prettyPhoto.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_flexslider_js',  plugins_url( '/assets/js/flexslider.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_matchheight_js',  plugins_url( '/assets/js/jquery.matchHeight-min.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_video_background_js',  plugins_url( '/assets/js/video-backgrounds.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_fotorama_js',  plugins_url( '/assets/js/fotorama.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_flipbox_js',  plugins_url( '/assets/js/flip.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_team_js',  plugins_url( '/assets/js/team.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
	wp_register_script( 'boosted_elements_progression_image_compare_js',  plugins_url( '/assets/js/jquery.images-compare.js', BOOSTED_ELEMENTS_PROGRESSION_FILE__ ), '','1.0',true);
