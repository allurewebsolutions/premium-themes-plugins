	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					[
						'name' => 'boosted_elements_nav_repeater_text_field',
						'label' => esc_html__( 'Section Title', 'boosted-elements-progression' ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
					],
					[
						'name' => 'boosted_elements_nav_repeater_content_id',
					...
					[
						'name' => 'boosted_elements_nav_repeater_icon',
						'type' => Controls_Manager::ICONS,
						'label_block' => true,
					],
					[
						'name' => 'boosted_elements_nav_repeater_icon_before_after',
					...
					[
						'name' => 'boosted_elements_nav_repeater_content_external_link',
					...
					[
						'name' => 'boosted_elements_nav_repeater_bullet_icon',
