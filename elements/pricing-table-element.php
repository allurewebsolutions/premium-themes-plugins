	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					[
						'name' => 'boosted_elements_feature_repeater_text_field',
						'label' => esc_html__( 'Feature', 'boosted-elements-progression' ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
					],
					[
						'name' => 'boosted_elements_feature_repeater_icon',
						'type' => Controls_Manager::ICONS,
					],
					[
						'name' => 'boosted_elements_feature_repeater_icon_color',
					...
					[
						'name' => 'boosted_elements_feature_repeater_strike_through',
