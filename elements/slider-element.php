...
class Widget_BoostedElementsSlider extends Widget_Base {
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
		...
		$boosted_slide_repeat->add_group_control(
		...
		$boosted_slide_repeat->add_responsive_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Content Background Color', 'boosted-elements-progression' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
