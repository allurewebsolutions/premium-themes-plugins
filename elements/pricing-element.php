	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					[
						'name' => 'boosted_elements_price_repeater_title_field',
						'label' => esc_html__( 'Title', 'boosted-elements-progression' ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
					],
					[
						'name' => 'boosted_elements_price_repeater_text_price',
						'label' => esc_html__( 'Price', 'boosted-elements-progression' ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
					],
					[
						'name' => 'boosted_elements_price_repeater_main_text_field',
						'label' => esc_html__( 'Main Text', 'boosted-elements-progression' ),
						'type' => Controls_Manager::TEXTAREA,
						'label_block' => true,
					],
					[
						'name' => 'boosted_elements_price_repeater_content_external_link',
					...
					[
						'name' => 'boosted_elements_price_repeater_image',
					...
					[
						'name' => 'boosted_elements_price_repeater_image_field',
	...
	<ul class="boosted-elements-progression-price-menu-list-container">	
		<?php foreach ( $settings['boosted_elements_price_repeater'] as $item ) :  ?>
			<li>
				...
				<?php if ( ! empty( $item['boosted_elements_price_repeater_content_external_link']) ) : ?></a><?php endif; ?>
