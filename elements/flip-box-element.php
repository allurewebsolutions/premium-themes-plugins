...
class Widget_BoostedElementsFlipBox extends Widget_Base {
   ...
   public function get_categories() {
	...
	public function get_script_depends() { 
		return [ 'boosted_elements_progression_flipbox_js' ]; 
	}
					...
					<div class="boosted-elements-flip-box-vertical-align">
						<div class="boosted-elements-flip-box-padding">
							...
							<?php if ( ! empty( $settings['boosted_elements_flip_front_heading'] ) ) : ?>
								<h2 class="boosted-elements-flip-box-heading"><?php echo '<div ' . $this->get_render_attribute_string( 'boosted_elements_flip_front_heading' ) . '>' . $this->get_settings( 'boosted_elements_flip_front_heading' ) . '</div>';?></h2>
							<?php endif; ?>
							<?php if ( ! empty( $settings['boosted_elements_flip_front_content'] ) ) : ?>
								<div class="boosted-elements-flip-box-content"><?php echo '<div ' . $this->get_render_attribute_string( 'boosted_elements_flip_front_content' ) . '>' . $this->get_settings( 'boosted_elements_flip_front_content' ) . '</div>';?></div>
							<?php endif; ?>
							<?php if ( ! empty( $settings['boosted_elements_flip_front_btn_text'] ) ) : ?>
								<div class="boosted-elements-button">
									...
									<?php endif; ?>
									<?php echo '<div ' . $this->get_render_attribute_string( 'boosted_elements_flip_front_btn_text' ) . '>' . $this->get_settings( 'boosted_elements_flip_front_btn_text' ) . '</div>';?>
					...
					<div class="boosted-elements-flip-box-vertical-align">
						<div class="boosted-elements-flip-box-padding">
							...
							<?php if ( ! empty( $settings['boosted_elements_flip_rear_heading'] ) ) : ?>
								<h2 class="boosted-elements-flip-box-heading"><?php echo '<div ' . $this->get_render_attribute_string( 'boosted_elements_flip_rear_heading' ) . '>' . $this->get_settings( 'boosted_elements_flip_rear_heading' ) . '</div>';?></h2>
							<?php endif; ?>
							<?php if ( ! empty( $settings['boosted_elements_flip_rear_content'] ) ) : ?>
								<div class="boosted-elements-flip-box-content"><?php echo '<div ' . $this->get_render_attribute_string( 'boosted_elements_flip_rear_content' ) . '>' . $this->get_settings( 'boosted_elements_flip_rear_content' ) . '</div>';?></div>
							<?php endif; ?>
							...
							<?php if ( ! empty( $settings['boosted_elements_flip_rear_btn_text'] ) ) : ?>
								<?php if ( $settings['boosted_elements_table_button_apply_to'] == 'boosted_button_link' &&  ! empty( $settings['boosted_elements_flip_box_link']['url'] ) ) : ?><a <?php if ( ! empty( $settings['boosted_elements_flip_box_link']['nofollow'] ) ) : ?>rel="nofollow"<?php endif; ?> href="<?php echo esc_url($settings['boosted_elements_flip_box_link']['url']); ?>" <?php if ( ! empty( $settings['boosted_elements_flip_box_link']['is_external'] ) ) : ?>target="_blank"<?php endif; ?>><?php endif; ?><div class="boosted-elements-button">
									...
									<?php endif; ?>
									<?php echo '<div ' . $this->get_render_attribute_string( 'boosted_elements_flip_rear_btn_text' ) . '>' . $this->get_settings( 'boosted_elements_flip_rear_btn_text' ) . '</div>';?>
